...
var msgHistory = document.querySelector('#history');
  session.on('signal:msg', function(event) {
    ...
    $("#history").append("<div class='msg-tile consultants-msg'><div class='consultants-img'><img src='http://gotouniversity.com/partner/web/noprofile.gif'/></div><p class='consultants-msg-text'>"+event.data+"</p></div>");  
    }
