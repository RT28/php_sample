        ...
        <div class="row">
              ...
              <div class="edugate-widget widget">
                ...
                <div class="useful-link-list">
                  <ul class="list-unstyled">
                          <li><i class="fa fa-angle-right"></i><a href="?r=site/contact"> Contact Us</a></li>

                          <li class="f-address"><i class="fa fa-map-marker" aria-hidden="true"></i> Our Address:<br>
						  Go to university.<br>
              1355 Market Street, Suite 900 <br>
              San Francisco, CA 94103 <br>
              P: (123) 456-7890 </li>

                          <li><a href="mailto:info@gotouniversity.com"><i class="fa fa-envelope-o" aria-hidden="true"></i>&nbsp
                    info@gotouniversity.com</a></li>
            ...
            <div class="col-md-3 col-sm-3 sd380">
              <div class="useful-link-widget widget">
                <div class="title-widget">Select your Destination</div>
                <div class="content-widget">
                  <div class="useful-link-list">
                        <ul class="list-unstyled">
                          ...
                          <li><i class="fa fa-angle-right"></i><a href="?r=university/index">University Information</a></li>
                          <li><i class="fa fa-angle-right"></i><a href="?r=site/portfolio">Program Information</a></li>
                        </ul>
                  </div>
                </div>
              </div>
