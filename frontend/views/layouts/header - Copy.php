...
<div class="bs-demo-dropdowns text-center">
        <div class="container">
          <div class="dropdown dropdown-inline">
            <a href="#" class="btn btn-default dropdown-toggle" data-toggle="dropdown" data-hover="dropdown">Education <span class="caret"></span></a>
            <ul class="dropdown-menu" role="menu">
              
              <li class="dropdown">
                <a href="#">Webinars<span class="caret"></span></a>
                <ul class="dropdown-menu dropdownhover-right">
                  <li><a href="?r=webinar/index">Upcoming Live Webinars</a></li>
                  <li><a href="#">On Demand Webinars</a></li>
                  <li class="dropdown">
                    <a href="#">Online Education <span class="caret"></span></a>
              ...
              <li><a href="#">News and Alerts</a></li>
            </ul>
          </div>
...
<script src="http://localhost/test/js/bootstrap-dropdownhover.js"></script>
  <div class="header-main homepage-01">
    ...
    <input type="hidden" id="from_role" value="<?= Roles::ROLE_STUDENT; ?>">
		...
		<li><a href="?r=student/view">Profile</a></li>
