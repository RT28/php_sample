        ...
        <div class="row">
          <div class="col-md-6 col-sm-6">
            <ul class="footer-menu">
              ...
              <li><a role="button" data-toggle="modal" data-target="#footer-form"><?= Yii::t('gtufooter', 'Drop a Message') ?></a></li>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel"><?= Yii::t('gtufooter', 'Drop a Message') ?></h4>
      </div>
      <div class="modal-body">
        <div class="contect-form-footer">
				...
				<option value=""><?= Yii::t('gtufooter', 'Country Code') ?></option>
