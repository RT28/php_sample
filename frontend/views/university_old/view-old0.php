...
<div class="row">
<div class="col-sm-2">
<img src="<?= $logo; ?>" alt="" class="university-logo" />
</div>
<div class="col-sm-6">
<h1 class="uni-name"> <?= $model->name ?> <small>EST. <?= $model->establishment_date ?></small> </h1>
<h2 class="uni-country"> <?= $model->country->name ?> </h2>
<div class="uni-website"> <a href="<?= $model->website ?>" target="_blank"><?= $model->website ?></a></div>
</div>
<div class="col-sm-4">
<?php
$bestRank = 'NA';
...
?>
<div class="ranking"> Ranking <span> <?= $bestRank ?></span></div>
<div class="row uni-links">
<?php
$url = '?r=site/login';
?>
<div class="col-xs-4"> <a class="btn-review" href="<?= (!Yii::$app->user->isGuest) ? '?r=university/review&university=' . $model->id : $url ?>"><img src="/images/review-blue.png"> Review</a> </div>
...
?>
<div class="col-xs-4"> <a class="btn-favourites" href="<?= (!Yii::$app->user->isGuest) ? '?r=university/favourite' : $url ?>"><img src="<?= $src; ?>"><span><?= $text ?></span></a> </div>
</div>
</div>
</div>
</div>
...
<li class="active"><a class="program-tabs" href="#tab-aboutus" data-toggle="tab" aria-expanded="false">About Us</a></li>
...
Application Requirements</a></li>

<li ><a class="program-tabs" href="#tab-cost" data-toggle="tab" aria-expanded="true">Cost</a></li>

<li class=""><a class="program-tabs" href="#tab-deadlines" data-toggle="tab">Deadlines</a></li>
...
<div class="col-sm-12 text-center "><a class="btn btn-blue pull-right" href="?r=university/download-all&id=<?php echo $model->id; ?>"> Download All</a></div>
...
<?php  
if($ext=="pdf"){ ?>
<img src="./../../frontend/web/images/pdficon.jpg" alt="document" height="150">
 
<?php }else if($ext=="docx" || $ext=="doc" ){ ?>
<img src="./../../frontend/web/images/docxicon.jpg" alt="document" height="150">
<?php } else { ?>
<img src="?r=university/download&name=<?= $document_file; ?>&id=<?php echo $model->id; ?>" alt="document" height="150">
<?php } ?>
<div class="caption"> 
<p><?= $document_name; ?></p> 
<p><a href="?r=university/download&name=<?= $document_file; ?>&id=<?php echo $model->id; ?>" role="button"><i class="glyphicon glyphicon-download-alt" aria-hidden="true"></i> </a>	 
</p>
</div>
</div>
</div> 	
