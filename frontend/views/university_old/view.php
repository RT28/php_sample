...
<?php if($model->no_of_students!=0 ){?>
<div data-from="0" data-to="<?= $model->no_of_students ?>" data-speed="1000" class="num">0</div>
<?php }else{?>
<div data-from="NA" data-to="NA" data-speed="1000" class="num">NA</div> 
<?php }?> 
...
<div class="col-sm-2">
<div class="progress-bar-number">
<?php if($model->no_of_international_students!=0 ){?>
...
<div class="col-sm-2">
<div class="progress-bar-number">
<?php if($model->no_of_undergraduate_students!=0 ){?>
...
<div class="col-sm-2">
<div class="progress-bar-number">
<?php if($model->no_of_post_graduate_students!=0 ){?>
...
<div class="col-sm-2">
<div class="progress-bar-number">
<?php if($model->no_of_international_faculty!=0 ){?>
...
if (is_JSON($rank)) { 
  ...
  <div class="video-link">
    <a href="<?php echo $jrank['url'];?>"> 
	<iframe width="100%" height="400px" src="<?php echo $jrank['url'];?>" frameborder="0" allowfullscreen></iframe>
    </a>
  </div>
</div> 
<?php
