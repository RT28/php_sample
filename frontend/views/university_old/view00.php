  ...
  <div class="col-sm-6">
    <div class="review-card">
        ...
        <div class="review-user-info">
          <h3 class="review-user-name">Mark Zuckerberg</h3>
          ...
          <p class="review-user-content">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut.</p>
        </div>
    </div>
  </div>
    <div class="col-sm-6">
