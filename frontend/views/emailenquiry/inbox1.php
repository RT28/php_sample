...
<div class="col-sm-12">
  ...
  <div class="tab-content">
    ...
    <?php if(!empty($emailenquiries)){ ?>
     	<div class="col-sm-4 pad-left-0 pad-right-0" style="height: 357px;overflow: scroll;">
              <!-- Nav tabs -->
              <ul class="nav nav-tabs" role="tablist">
              <?php $i = 0; $active = ''; foreach($emailenquiries as $emailenquiry) { if($i==0) {$active = 'active'; } else {$active = '';} ?>
                <li role="presentation" class="<?php echo $active; ?>"><a href="#<?php echo $i; ?>" aria-controls="1" role="tab" data-toggle="tab">
     ...
     <?php } ?>
       <div class="col-sm-8 pad-tight-0">
          ...
          <?php $j = 0; $active = ''; foreach($emailenquiries as $emailenquiry) { if($j==0) {$active = 'active'; } else {$active = '';} ?>
            <div role="tabpanel" class="tab-pane <?php echo $active; ?>" id="<?php echo $j; ?>">
            	<div class="subject-sender-details">
            		<h3 class="msg-subject"><?php echo $emailenquiry['subject']; ?></h3>
