...
<a class="btn btn-blue" href="/universities">View Universities</a>
  ...
  <?php if(sizeof($models) === 0): ?>
        <h2> You haven't shortlisted any universities yet.</h2>
...
<div class="col-md-4 col-sm-6">
    <div class="course-box">
        ...
        <div class="row">
 <div class="col-sm-8">
 <?php if(UniversityCourseList::find()->where(['=', 'university_id', $model->university->id])->count() > 0){
            $course_count = UniversityCourseList::find()->where(['=', 'university_id', $model->university->id])->count();
            $prg_text = 'Programs';
            } else {
            $course_count = '&nbsp;';
            $prg_text = '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;';    
            } ?>
	   <div class="program-count"><div class="programm-units"><?= $course_count; ?></div> <?= $prg_text; ?></div>
       </div>
