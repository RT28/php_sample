...
?>
<li class="<?php echo $activeDiv;?>"><a class="program-tabs" href="#tab-<?php echo $categorySingle['id']; ?>" data-toggle="tab" aria-expanded="false" onclick="get_faqList('<?php echo $categorySingle['id']; ?>');">
<i class="fa fa-file-text-o" aria-hidden="true"></i> <?php  echo $categorySingle['category']; ?></a></li>
