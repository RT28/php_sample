...
?>
        ...
        <?php $trainee_id_c = $model->partner_login_id + 1;
            $profile_path = "./../../partner/web/uploads/employee/".$trainee_id_c."/profile_photo/consultant_image_228X228";
        ...
        ?>
                  <div class="col-sm-12">
                    ...
                    <div class="consultant-list-top-point" id="<?= $model->partner_login_id ?>"></div> 
                    <a role="button" data-toggle="collapse" href="#consultant<?= $model->partner_login_id ?>" aria-expanded="false" aria-controls="consultant<?= $model->partner_login_id ?>">
                      <div class="trigger">
                        <div class="row">
                          <div class="col-sm-4">
                      ...
                      <div class="collapse" id="consultant<?= $model->partner_login_id ?>">
                        <div class="">
                        	<div class="row">
                            	<div class="col-sm-8">
                                  <div class="consultant-info-div">
