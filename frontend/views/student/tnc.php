...
<div id="wrapper-content"><!-- PAGE WRAPPER-->
  <div id="page-wrapper"><!-- MAIN CONTENT-->
	...
	<li>Though this is a free package in case of any administrative charges (if applicable) will be communicated to you by the counselor.</li>
		...
		<?php }?>
	<p>  <?= $form->field($model, 'agree')->checkbox() ?> I hereby agree to abide by the terms and conditions mentioned above and I provide my consent to subscribe the <?= $tncDetail->name?>. </p>
	</div>
	</div>
	
	<?= Html::submitButton('Subscribe the ' .$tncDetail->name, ['class' => 'btn btn-blue', 'name' => 'signup-button']); ?>
