...
<ul class="dashboard-left-menu">
	...
	<li class="s-univ-tab"><a href="/favourite-universities/student-not-subscribed" class="">Shortlisted Universities</a></li>
</ul>
...
<div class="row"> 
    ...
    <h1><?= Html::encode($this->title) ?></h1>
            <a class="btn btn-blue pull-right" href="/course/index">View Programs</a>
    </div>
    </div>
                ...
                <div class="panel-title program-title">
                    <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapse-<?= $i?>" aria-expanded="false" aria-controls="collapse-<?= $i?>">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                ...
                                <a title="University" href="/university/view?id=<?= $university->id ?>" target="_blank"><p class="university-name" title="<?= $university->name ?>"><?= $university->name ?></p></a>
                    ...
                    <?php 
                        ...
                        //$str = $model->name;
                         //echo $str_dn;
                     ?>
        <h4 class="university-name"><?= Html::a($university->name, ['university/view', 'id' => $url_key], ['class' => 'profile-link','title'=>$university->name]) ?></h4>
