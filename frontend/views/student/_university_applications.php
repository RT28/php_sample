...
<?php foreach($models as $model): ?>
	<tr class="table-row">
		<td class="col-1"><span><a href="/university-applications/view?id=<?= $model->id;?>"><?= $model->course->name; ?></a></span></td>
		<td class="col-2"><a href="/university/view?id=<?= $model->university->id; ?>"><?= $model->university->name;?></a></td>
		<?php
