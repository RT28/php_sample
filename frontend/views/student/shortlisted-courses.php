...
<div class="">
    ...
    <?php if(sizeof($models) === 0): ?>
        ...
        <div class="col-xs-12 text-center">
            <a class="btn btn-blue" href="/course/index?degreeLevel=Bachelors">View Programs</a>
        </div>
    <?php else: ?>
        <?php foreach($models as $model): ?>
            <div class="col-xs-12 bordered">
                ...
                <p>
                    <a href="/university/view?id=<?= $model->university->id; ?>"><?= $model->university->name; ?></a>
                </p>
                <?php
                ...
                <?php if(empty($counsellingSession)): ?>
                    <a href="/site/register-for-free-counselling-session" class="btn btn-blue">Click to get Free counselling session</a>
                <?php endif; ?>
