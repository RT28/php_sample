...
<div class="chat-name"><?= $conslt->first_name.''.$conslt->last_name; ?></div>
...
<?php if($consultant>0){
foreach($consultant as $conslt): ?>
<option value="<?= $conslt->consultant_id ?>" role="<?= Roles::ROLE_CONSULTANT ?>"><?= $conslt->first_name.''.$conslt->last_name; ?></option>
<?php endforeach; 
}?>
</select>
