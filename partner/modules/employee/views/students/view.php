...
<li role="presentation"><a href="#associates" aria-controls="associates" role="tab" data-toggle="tab">Associate Consultants</a></li>
<?php }?>
...
<div class="tab-content">
	...
	<div role="tabpanel" class="tab-pane" id="documents">
		<?= $this->render('_documents', [
			'model' => $model,
			'stud_documentlist' => $stud_documentlist,
