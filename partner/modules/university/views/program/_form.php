...
<div class="col-sm-6" >
    <?= $form->field($model, 'intake')->textInput()->label('Intake')?>
 
 <?= $form->field($model, "type")->dropDownList($courseType) ?>
 
	  <?= $form->field($model, "language")->dropDownList($languages) ?>
    <?= $form->field($model, 'fees')->textInput()->label('Fees  ('.$symbol.')' )  ?>

    <?= $form->field($model, 'fees_international_students')->textInput()->label('Fees International Students ('.$symbol.')' )  ?>
 
	 
 
    <?= $form->field($model, 'application_fees')->textInput()->label('Application Fees ('.$symbol.')' ) ?>

    <?= $form->field($model, 'application_fees_international')->textInput()->label('Application Fees International ('.$symbol.')' ) ?>
