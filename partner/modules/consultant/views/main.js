...
function loadInvoiceView(id) {
     var params = {};
     params['id']=id;
    $('#taskPreview').load('http://gotouniversity/partner/web/index.php?r=consultant/invoice/view', params, function(responseText, status, xhr){
        if(status !== 'success') {
            // TODO error handling.
        }
    });
...
function loadQuestionView(id) {
     var params = {};
     params['id']=id;
    $('#taskPreview').load('http://gotouniversity/partner/web/index.php?r=consultant/universityinfo/view', params, function(responseText, status, xhr){
        if(status !== 'success') {
            // TODO error handling.
        }
    });
