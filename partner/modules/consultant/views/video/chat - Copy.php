...
<div class="col-sm-12">
    <div class="row">
                            ...
                            <div class="other-chat">
                                    ...
                                    foreach($students as $student){ $active_con = 'active';
                                        if($student['logged_status']==1) { $active_con = 'active'; } else { $active_con = ''; } 
                                            $name = $student['first_name']." ".$student['last_name']; echo $student['logged_status'];
                                         ?>
        ...
        <?php if(isset($openTokSessionToken) && !empty($openTokSessionToken)): ?>
            <input type="text" id="open-tok-api-key" value="<?= $openTokApiKey; ?>"/>
            <input type="text" id="open-tok-session-id" value="<?= $openTokSessionId; ?>"/>
            <input type="text" id="open-tok-token" value="<?= $openTokSessionToken; ?>"/>
        <?php endif;?>
    </div>
</div>
</div>
