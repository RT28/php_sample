...
<p id="event-id" class="hidden" value="<?= $events->id; ?>"></p>
        ...
        <div class="col-sm-6">
            ...
            <div class="form-group">
              ...
              <p id="event-type">
                ...
                if($consultant>0){ 
                                ...
                                ->andWhere('student_appointment_id = '.$events['student_appointment_id'])
                  ...
                  if($students>0){ 
                                ...
                                ->andWhere('consultant_appointment_id = '.$events['id'])
          ...
          <?php } else if($events['created_by']!==$consultant_id AND $events['created_by_role']!==Roles::ROLE_CONSULTANT){ ?>
            <div>
            ...
            <?php } ?>
            <button class="<?php echo $evclass_acc; ?>" onclick="changeEventStatus(1,'<?php echo $events['id']; ?>')" id="btn_e_accept<?php echo $events['id']; ?>">Accept</button><br><br>
            <button class="<?php echo $evclass_rej; ?>" id="btn_e_reject<?php echo $events['id']; ?>" onclick="changeEventStatus(2,'<?php echo $events['id']; ?>')">Reject</button>
            </div>
        <?php } ?>  
          </div>