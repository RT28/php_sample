...
<footer>
        ...
        <div class="row">
          <div class="col-md-6 col-sm-6">
            <ul class="footer-menu">
              <li><a href="<?=Url::to('partner/web/index.php?r=university/university-enquiry/create', true)?>">Partner With Us</a></li>
  ...
  <?php } }?>
  <div class="modal fade" id="footer-form" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="myModalLabel">Drop a Message</h4>
      </div>
      <div class="modal-body">
        <div class="contect-form-footer">
				...
				<div class="col-md-6 col-sm-6">
				<select id="contact-phone_code"  class="form-control"> 
...
<div class="col-md-6 col-sm-6">
				...
				<span id="contact-phone-help" class="help-block"></span>
                      ...
                      <button type="button" class="btn btn-blue" id="btn-send-contact-query">Submit <i class="fa fa-caret-right" aria-hidden="true"></i></button>
