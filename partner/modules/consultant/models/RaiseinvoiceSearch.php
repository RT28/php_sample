 ...
 */
class RaiseinvoiceSearch extends Tasks
{
    ...
    {
        $query = RaiseinvoiceSearch::find()->distinct()		
		 ->joinWith(['student']) 
		 ...
		 ->Where(['tasks.task_category_id'=>8])
		 ->andWhere(['tasks.status'=>0])
		 ->andWhere(['student_consultant_relation.consultant_id'=>$id]);
