...
class InvoiceSearch extends Invoice
{
    ...
    {
        return [
            [['id', 'consultant_id', 'agency_id', 'university', 'programme', 'gross_tution_fee','currency', 'discount', 'net_fee_paid', 'status'], 'integer'],
            [['refer_number','student_id', 'payment_date', 'intake', 'scholarship', 'invoice_attachment','comment', 'created_at', 'updated_at', 'created_by', 'updated_by', 'approved', 'approved_by','consultantdetails'], 'safe'],
        ];
    }
