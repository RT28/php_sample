...
$status = array(1=>'FollowUp Again',2=>'Not Interested',5=>'Other',6=>'Close Lead');
    ...
    <?php $form = ActiveForm::begin(['id'=>'leadfollowup-active-form',
     ...
     'options' => ['enctype' => 'multipart/form-data']]); ?>
        ...
        <div class="row">
            ...
            <div class="col-sm-5"> 
                <?= $form->field($model, "status")->dropDownList($status, ['prompt' => 'Select Response','onchange'=>'fn_followstatus(this.value)'])->label('Response of the student') ?>
            </div>
        </div>
