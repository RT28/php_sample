        ...
        <nav class="navigation collapse navbar-collapse pull-right">
          <ul class="nav-links nav navbar-nav">
            ...
            <?php if(Yii::$app->user->isGuest): ?>
              <li><a href="site/signup" class="main-menu">Sign Up</a></li>
            ...
            <?php if(!Yii::$app->user->isGuest): ?>
                <?php
                  ...
                  $user = Agency::find()->where(['=', 'partner_login_id', $model->id])->one();
                  if (!empty($user)) {
                    $name = $user->name;
                  } else {
                  ...
                  if (is_dir('./uploads/agency/'. $model->id . '/profile_photo')) {
                    $backgroundImage = "./uploads/agency/".$model->id."/profile_photo/consultant_image_228X228";
                ...
                <li class="button-login">
                  <div class="dropdown">
                    <button style="background-image: url(<?= $backgroundImage; ?>);"class="btn btn-default btn-login dropdown-toggle student-icon" type="button" id="dropdownMenu1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true"> 
                    <img src="https://www.gotouniversity.com/images/header-user-ic.png"></button>
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
					 
                        <li><a href="?r=agency/agency/index">My Profile</a></li>
                       <li><?php 
