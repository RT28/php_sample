...
$profile_type = array('1'=>'Prep Teacher','2'=>'Editor');
...
<?= $form->field($model, "profile_type")->dropDownList($profile_type, ['prompt' => 'Select Trainee Profile' , 'id' => 'profile_type'])->label('Trainee Profile') ?>
...
?>
		...
		'options' => ['placeholder' => 'Select Languages', 'multiple' => true],
		'pluginOptions' => ['tags' => true,]
		]); ?> 
