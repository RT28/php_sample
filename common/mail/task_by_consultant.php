...
Dear <?= $studentname; ?>,
<br/><br/> 
Greetings from GoToUniversity.<br/><br/>

Your counselor  has been deleted this task from your task list. 
<br/><br/>

<table width="100%" border="2">
<tbody> 
<tr>
<td width="20%"><strong>Created Date</strong></td><td width="80%" colspan="3"><?= $createddate;?></td> 
</tr>
<tr> 
...
<tr>
<td width="20%"><strong>Deadline</strong></td><td width="30%"><?= $deadline; ?></td>
