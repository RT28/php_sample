...
class Leads extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['student_id', 'first_name', 'last_name',   'date_of_birth', 'gender', 'address',  'city', 'state',  'country', 'nationality', 'pincode', 'email', 'phone', 'created_at', 'updated_at'], 'required'],
            [['student_id', 'state', 'country','pincode', 'father_phonecode', 'father_phone','mother_phonecode','mother_phone','code','gender'], 'integer'], 
            [['date_of_birth', 'created_at', 'updated_at','created_by', 'updated_by','language_proficiency' ], 'safe'],
