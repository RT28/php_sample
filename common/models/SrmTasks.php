...
/**
 * This is the model class for table "srm_tasks".
 *
 * @property integer $id
 ...
 */
class SrmTasks extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['srm_id', 'task_category_id', 'task_list_id', 'title', 'created_by', 'created_at', 'updated_by', 'updated_at'], 'required'],
            [['srm_id', 'task_category_id', 'task_list_id', 'status'], 'integer'],
