                        ...
                        <td>
                            <div class="form-group">
                                ...
                                <?php 
                                    if($univerityAdmisssions->course_id === 0) {
                                        print_r('All');
                                    } else if($univerityAdmisssions->course_id > 0) {
                                        $course = UniversityCourseList::findOne($univerityAdmisssions->course_id);
                            ...
                            <?php
                                ...
                                if($univerityAdmisssions->course_id != 0) {
                                    ...
                                    if(!empty($course))
                                        $admissionCourses = $course->name;
                                } else {
                                    $admissionCourses = 'All';
                                }
                            ?>
                            <?php
                                isset($admissionCourses)?print_r($admissionCourses):'-';
                            ?>
                        </td>
                        <td>
                             <div class="form-group">
