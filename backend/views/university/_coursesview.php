                    ...
                    <tr class="course-item"><!-- widgetBody -->
                        ...
                        <td>
                            <div class="form-group">
                                ...
                                <?= '<br>' ?>
                                <?php
                                    isset($courses->fees_international_students)?print_r($courses->fees_international_students):'-';
                                ?>
                            </div>
                        </td>
                        <td>
                        ...
                        <td>
                            <div class="form-group">
                                <?= Html::activeLabel($courses, "[{$i}]duration_type"); ?>
                                <?= '<br>' ?>
                                <?php
                                    isset($courses->duration)?print_r($courses->duration_type):'-';
                                ?>
                            </div>
                        </td>
                        <td>
                        ...
                        <td>
                            <div class="form-group">
                                <?= Html::activeLabel($courses, "[{$i}]standard_test_list"); ?>
                                <?= '<br>' ?>
                                <?php
                                    $tests = '-';
                                    if(isset($courses->standard_test_list)) {
                                        $tests = StandardTests::find()->where(['in', 'id', explode(',', $courses->standard_test_list)])->all();
                                        $temp  = [];
                                        foreach($tests as $test) {
                                            array_push($temp, $test->name);
                                        }
                                        $tests = implode(',', $temp);
                                    }
                                ?>
                        ...
                        <td>
                            <div class="form-group">
                                <?= Html::activeLabel($courses, "[{$i}]application_fees"); ?>
                                <?= '<br>' ?>
                                <?php
                                    isset($courses->application_fees)?print_r($courses->application_fees):'-';
                                ?>
                            </div>
                        </td>
                        <td>
                            <div class="form-group">
                                <?= Html::activeLabel($courses, "[{$i}]application_fees_international"); ?>
                                <?= '<br>' ?>
                                <?php
                                    isset($courses->application_fees_international)?print_r($courses->application_fees_international):'-';
                                 ?>
                            </div>
                        </td>
                        <td>
                        ...
                        <td>
                            <div class="form-group">
                                <?= Html::activeLabel($courses, "[{$i}]careers"); ?>
                                <?= '<br>' ?>
                                <?php
                                    isset($courses->careers)?print_r($courses->careers):'-';
                                ?>
                            </div>
                        </td>
                        <td>
                            <div class="form-group">
                                <?= Html::activeLabel($courses, "[{$i}]eligibility_criteria"); ?>
                                <?= '<br>' ?>
                                <?php
                                    isset($courses->eligibility_criteria)?print_r($courses->eligibility_criteria):'-';
                                ?>
                            </div>
                        </td>
                    </tr>
