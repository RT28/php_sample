        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="form-group text-center">
                    ...
                    <input type="button" class="btn btn-primary" onclick="initGoogleMap()" value="Update Map">
                </div>   
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-6">
                        <?= $form->field($model, 'acceptance_rate')->textInput() ?>
                    </div>
                    <div class="col-xs-12 col-sm-6">
                        <?= $form->field($model, 'student_facuilty_ratio')->textInput() ?>
                    </div>
                </div>
            </div>
        </div>               
    ...
    <div class="col-xs-12 col-sm-6">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <?= $form->field($model, 'ielts')->textInput() ?>
                    </div>
                    <div class="col-xs-12 col-sm-6">
                        <?= $form->field($model, 'tofel')->textInput() ?>
                    </div>
                    <div class="col-xs-12 col-sm-6">
                    ...
                    <div class="col-xs-12 col-sm-6">
                        <?= $form->field($model, 'gre')->textInput() ?>
                    </div>
                    <div class="col-xs-12 col-sm-6">
                        <?= $form->field($model, 'gmat')->textInput() ?>
                    </div>
                </div>
            </div>
        </div>               
    ...
    <div class="col-xs-12 col-sm-6">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <?= $form->field($model, 'ib_score')->textInput() ?>
                    </div>
                    <div class="col-xs-12 col-sm-6">
                        <?= $form->field($model, 'gcse_score')->textInput() ?>
                    </div>
                    <div class="col-xs-12 col-sm-6">
                        <?= $form->field($model, 'gpa_score')->textInput() ?>
                    </div>
                </div>
            </div>
        </div>               
