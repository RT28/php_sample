...
<div class="student-standard-test-detail-form">
    ...
    'onchange' => 
    'var url = "http://localhost/gotouniversity/backend/web/index.php?r=student-standard-test-detail/getsubjects&test_id="+$(this).val()+"&marks='.$model->test_marks.'";
            $.ajax({
                type:"POST",
                url: url,
    ...
    <?= $form->field($model, 'other_test')->textInput(['maxlength' => true]) ?>
    <?php $other_test_error = isset($error1)?$error1:''; echo $other_test_error; ?>
    <?php } ?>

    <?php if($model->test_id == 0){ ?>
    <?= $form->field($model, 'test_authority')->textInput(['maxlength' => true]) ?>
    ...
    <div class="col-md-12" id="test-marks" style="padding-left:0px;">
        <div class="col-md-12 form-group" style="padding-left:0px;"><b><?php echo $model->getAttributeLabel('test_marks'); ?></b></div>
