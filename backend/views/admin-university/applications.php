    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                'value' => 
                function ($model) {
                    $student = Student::findOne(['student_id'=>$model->student_id]);
            ...
            'start_term',
             [
                ...
                'filter'=>Html::dropDownList('StudentUniversityApplicationSearchNew[status]',isset($_REQUEST['StudentUniversityApplicationSearchNew']['status']) ? $_REQUEST['StudentUniversityApplicationSearchNew']['status'] : null,AdmissionWorkflow::getStates(),['class' => 'form-control', 'prompt' => 'Select status'])
            ],              
            'remarks',
